---
title: Corso Database SQL
---

# Corso Database SQL

Questo corso introduce i concetti fondamentali dei database relazionali e del linguaggio SQL, partendo dalle basi teoriche fino ad arrivare a progettazione, query avanzate e deploy.
...
- progettare correttamente uno schema dati
- scrivere query SQL corrette, leggibili e scalabili
